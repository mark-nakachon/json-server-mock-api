...
describe("GET /api/configure/device", () => {
  ...
  test("It should require token for authorization", async done => {
    const response = await request.get(
      `/api/configure/device?model=${config.model}`
    );
  ...
  test("It responds with JSON", async done => {
    const response = await request
      .get(`/api/configure/device?model=${config.model}`)
  ...
  test("It responds with unprocessable entry", async done => {
    const response = await request
      .get("/api/configure/device?model=")
      .set("x-access-token", token);
    expect(response.status).toBe(422);
    done();
  });
  ...
  test("It responds with Not Found", async done => {
    const response = await request
      .get("/api/configure/device?model=123eqecqw")
      .set("x-access-token", token);
    expect(response.status).toBe(404);
    done();
  });
...
describe("GET /api/locate/order", () => {
  ...
  test("It should require token for authorization", async done => {
    const response = await request.get(
      `/api/locate/order?orderno=${config.orderno}&itemno=${config.itemno}`
    );
    expect(response.status).toBe(403);
    done();
  });
  ...
  test("It responds with unprocessable entry", async done => {
    const response = await request
      .get("/api/locate/order?orderno=&itemno=")
      .set("x-access-token", token);
    expect(response.status).toBe(422);
    done();
  });
  ...
  test("It responds with Not Found", async done => {
    const response = await request
      .get(
        `/api/locate/order?orderno=${faker.random.alphaNumeric(
          (number = 10)
  ...
  test("It responds with unprocessable entry if more than 10,5 chars are provided", async done => {
    const response = await request
      .get(
        `/api/locate/order?orderno=${faker.random.alphaNumeric(
          (number = 5)
        )}&itemno=${faker.random.alphaNumeric((number = 10))}`
      )
      .set("x-access-token", token);
    expect(response.status).toBe(422);
    done();
...
describe("GET /api/search/order", () => {
  ...
  test("It should require token for authorization", async done => {
    const response = await request.get(
      `/api/search/order?orderno=${config.orderno}&itemno=${config.itemno}&model_like=rs`
    );
    expect(response.status).toBe(403);
    done();
  });
  ...
  test("It responds with JSON", async done => {
    const response = await request
      .get(
        `/api/search/order?orderno=${config.orderno}&itemno=${config.itemno}&model_like=${config.model}`
      )
      .set("x-access-token", token);
    expect(response.status).toBe(200);
    expect(response.type).toBe("application/json");
  ...
  test("It responds with JSON", async done => {
    const response = await request
      .get(
        `/api/search/order?orderno=${config.orderno}&itemno=${config.itemno}&IpAddress_like=${config.ipaddress}`
      )
      .set("x-access-token", token);
    expect(response.status).toBe(200);
    expect(response.type).toBe("application/json");
  ...
  test("It responds with unprocessable entry", async done => {
    const response = await request
      .get("/api/search/order?orderno=&itemno=&model_like=rs")
      .set("x-access-token", token);
    expect(response.status).toBe(422);
    done();
  });
